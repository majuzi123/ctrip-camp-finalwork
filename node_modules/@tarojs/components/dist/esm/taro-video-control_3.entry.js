import { r as registerInstance, h, H as Host, g as getElement, c as createEvent } from './index-c948674f.js';
...
const Video = class {
  constructor(hostRef) {
    ...
    this.init = () => {
      ...
      if (isHls(src)) {
        import('./hls-221423a1.js').then(function (n) { return n.h; }).then(e => {
          const Hls = e.default;
          this.HLS = Hls;
          if (Hls.isSupported()) {
            if (this.hls) {
