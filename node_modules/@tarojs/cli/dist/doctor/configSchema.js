...
const schema = Joi.object().keys({
    ...
    plugins: Joi.array().items(Joi.alternatives(Joi.string(), Joi.array().ordered(Joi.string().required(), Joi.alternatives().try(Joi.object(), Joi.function())))),
    presets: Joi.array().items(Joi.alternatives(Joi.string(), Joi.array().ordered(Joi.string().required(), Joi.object()))),
    ...
    compiler: Joi.alternatives(Joi.string().valid('webpack4', 'webpack5'), Joi.object().keys({
    ...
    h5: Joi.object().keys({
        ...
        output: Joi.object(),
        router: Joi.object(),
        esnextModules: Joi.array().items(Joi.alternatives(Joi.string(), Joi.object().instance(RegExp))),
        // DEPRECATED: https://nervjs.github.io/taro/docs/config-detail.html#deprecated-h5webpack
        webpack: Joi.forbidden(),
        // https://webpack.js.org/configuration/entry-context/#entry
        entry: Joi.alternatives(Joi.string(), Joi.array().items(Joi.string()), Joi.object().pattern(Joi.string(), Joi.alternatives(Joi.string(), Joi.array().items(Joi.string()))), Joi.func()),
        enableSourceMap: Joi.bool(),
        sourceMapType: Joi.string(),
