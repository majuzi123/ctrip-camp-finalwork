...
function createFiles(creator, files, handler, options) {
    const { description, projectName, version, css, date, typescript, template, templatePath, projectPath, pageName, framework, compiler } = options;
    const logs = [];
    // 模板库模板，直接创建，不需要改后缀
...
function createPage(creator, params, cb) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const logs = createFiles(creator, files, handler, Object.assign(Object.assign({}, params), { templatePath, projectPath: projectDir, pageName, period: 'createPage' }));
        creator.fs.commit(() => {
            // logs
            console.log();
