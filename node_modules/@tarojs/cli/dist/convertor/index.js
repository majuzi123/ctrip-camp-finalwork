...
class Convertor {
    constructor(root) {
        this.wxsIncrementId = (0, helper_2.incrementId)();
        this.root = root;
                ...
                enter(astPath) {
                    astPath.traverse({
                        ...
                        ImportDeclaration(astPath) {
                            ...
                            (0, helper_2.analyzeImportUrl)(self.root, sourceFilePath, scriptFiles, source, value);
                        },
                        CallExpression(astPath) {
                            ...
                            if (callee.type === 'Identifier') {
                                if (callee.name === 'require') {
                                    ...
                                    (0, helper_2.analyzeImportUrl)(self.root, sourceFilePath, scriptFiles, args[0], value);
                                }
                    ...
                    if (lastImport) {
                        ...
                        if (imports && imports.length) {
                            imports.forEach(({ name, ast, wxs }) => {
                                ...
                                lastImport.insertAfter((0, template_1.default)(`import ${importName} from '${(0, helper_1.promoteRelativePath)(path.relative(outputFilePath, importPath))}'`, babylon_1.default)());
                            });
                        }
                        if (depComponents && depComponents.size) {
                            depComponents.forEach(componentObj => {
                                ...
                                lastImport.insertAfter((0, template_1.default)(`import ${name} from '${(0, helper_1.promoteRelativePath)(path.relative(sourceFilePath, component))}'`, babylon_1.default)());
                            });
                        }
                    }
                }
    ...
    getApp() {
        ...
        try {
            ...
            if (fs.existsSync(this.entryStylePath)) {
                ...
                (0, helper_1.printLog)("convert" /* processTypeEnum.CONVERT */, '入口样式', this.generateShowPath(this.entryStylePath));
            }
        }
        catch (err) {
            this.entryJSON = {};
...
${code}
    ...
    generateEntry() {
        try {
            ...
            (0, helper_1.printLog)("generate" /* processTypeEnum.GENERATE */, '入口文件', this.generateShowPath(entryDistJSPath));
            if (this.entryStyle) {
        ...
        this.pages.forEach(page => {
            ...
            try {
                ...
                if (fs.existsSync(pageConfigPath)) {
                    (0, helper_1.printLog)("convert" /* processTypeEnum.CONVERT */, '页面配置', this.generateShowPath(pageConfigPath));
                        ...
                        Object.keys(pageUsingComponents).forEach(component => {
                            ...
                            if (unResolveComponentPath.startsWith('plugin://')) {
                                ...
                                if (unResolveComponentPath.startsWith(this.root)) {
                                    ...
                                    if (!fs.existsSync((0, helper_1.resolveScriptPath)(componentPath))) {
                ...
                if (fs.existsSync(pageStylePath)) {
                    (0, helper_1.printLog)("convert" /* processTypeEnum.CONVERT */, '页面样式', this.generateShowPath(pageStylePath));
        ...
        components.forEach(componentObj => {
            ...
            try {
                ...
                if (fs.existsSync(componentTemplPath)) {
                    (0, helper_1.printLog)("convert" /* processTypeEnum.CONVERT */, '组件模板', this.generateShowPath(componentTemplPath));
                    param.wxml = String(fs.readFileSync(componentTemplPath));
                }
                let componentStyle = null;
                if (fs.existsSync(componentStylePath)) {
                    (0, helper_1.printLog)("convert" /* processTypeEnum.CONVERT */, '组件样式', this.generateShowPath(componentStylePath));
                ...
                (0, helper_1.printLog)("generate" /* processTypeEnum.GENERATE */, '组件文件', this.generateShowPath(componentDistJSPath));
                if (componentStyle) {
    ...
    processStyleAssets(content, stylePath, styleDist) {
        const reg = /url\(["'](.+?)["']\)/g;
        ...
        while (token === null || token === void 0 ? void 0 : token.length) {
            ...
            if (url &&
                ...
                if (!fs.existsSync(originPath)) {
                    ...
                    (0, helper_1.printLog)("copy" /* processTypeEnum.COPY */, '样式资源', this.generateShowPath(destPath));
                }
            }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const { imports, content } = processStyleImports(style, (str, stylePath) => {
                ...
                if (path.isAbsolute(relativePath)) {
                    relativePath = (0, helper_1.promoteRelativePath)(path.relative(filePath, path.join(this.root, stylePath)));
                }
    ...
    generateConfigFiles() {
        ...
        creator.fs.commit(() => {
            ...
            (0, helper_1.printLog)("generate" /* processTypeEnum.GENERATE */, '文件', this.generateShowPath(path.join(this.convertRoot, '.eslintrc')));
            (0, helper_1.printLog)("generate" /* processTypeEnum.GENERATE */, '文件', this.generateShowPath(path.join(this.convertDir, 'index.html')));
            this.showLog();
        });
    }
    showLog() {
