...
class MiniWebpackModule {
    ...
    getModules() {
        ...
        const { buildAdapter, sassLoaderOption, lessLoaderOption, stylusLoaderOption } = config;
    ...
    getCSSLoaders(postcssOption, cssModuleOption) {
        const { appPath, config } = this.combination;
        const { designWidth = 750, deviceRatio, cssLoaderOption } = config;
        ...
        const postCSSLoader = WebpackModule_1.WebpackModule.getPostCSSLoader({
            postcssOptions: {
                plugins: (0, postcss_mini_1.getPostcssPlugins)(appPath, {
                    designWidth,
                    deviceRatio,
                    postcssOption
                })
