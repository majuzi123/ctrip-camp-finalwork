...
class Prerender {
    ...
    writeXML(config) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [importTemplate, template] = fs_1.default.readFileSync(templatePath, 'utf-8').split('\n');
            ...
            str += `${xml}\n`;
            str += '</block>';
            fs_1.default.writeFileSync(templatePath, str, 'utf-8');
        });
    }
    writeScript(path) {
      ...
      if (typeof PRERENDER !== 'undefined') {
        module.exports = ${this.globalObject}._prerender
            ...
            fs_1.default.appendFile(path, s, 'utf8', () => {
                resolve();
            });
        });
    }
